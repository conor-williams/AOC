...
int tot = 0;
	...
	printf("bad ecl 2 %s\n",  people[i].ecl);
				...
				if (strlen(people[i].pid) == 9 &&
					isdigit(people[i].pid[0]) &&
					isdigit(people[i].pid[1]) &&
					isdigit(people[i].pid[2]) &&
					isdigit(people[i].pid[3]) &&
					isdigit(people[i].pid[4]) &&
					isdigit(people[i].pid[5]) &&
					isdigit(people[i].pid[6]) &&
					isdigit(people[i].pid[7]) &&
					isdigit(people[i].pid[8])) {
#ifdef _DEBUG_
