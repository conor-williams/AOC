...
<s>	bugs_2015 05/08/2025
	...
	bugs_2023 12/08/2025
	bugs_2024 18/08/2025</s>
Note: Haven't fixed most of the un-Java'ed ones yet
</pre>
<pre>
    bugs causes:
...
<!--<h3>YEAR: 2021</h3>-->	year: 2021
 ...
 <s>2021 day 21 part 2</s>  |  <s>2021 day 22 part 2</s>
...
2024.day24.2 is manual use of graphics (python dot etc...) (44 bit half/full adder kinda microchip) see readme on how: 2024.day24.2.readme.txt (have to run scripts)
</pre>
...
<s>2022.25.1 (known unfin... j.v -> c++ converter (didnt work cleanly))</s> c/c++ ver.
	2023
...
<pre>
	...
	o dup2 needed an fflush -- now no debug -- sorry (ps: remove/comment close(1)<b>;</b> after fd = dup(1); <b>;</b> for debug; if there is debug it will appear once you recompile)
...
<br>t+12 (tot) 070425@sun cormac battle on ratio @ 2am
<br>t+11th    ~110425
