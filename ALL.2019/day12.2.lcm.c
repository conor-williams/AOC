...
int main(int argc, char **argv)
{
	...
	if (argc < 4) {printf("give 3 nums\n"); exit(0);}
	unsigned long long ans =  lcm((unsigned long long)atoi(argv[1]), (unsigned long long)lcm(atoi(argv[2]), (unsigned long long)atoi(argv[3])));
	printf("%llu\n", ans);
