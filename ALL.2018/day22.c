...
int main(int argc, char **argv)
{
	...
	char (*grid)[tX+10] = (char (*)[tX+10])malloc(sizeof(char[tY+10][tX+10]));
	if (grid == NULL) {perror("gridE\n"); exit(0);}

	int (*geo)[tX+10] = (int (*)[tX+10])malloc(sizeof(int[tY+10][tX+10]));
	if (geo == NULL) {perror("geoE\n"); exit(0);}

	int (*ero)[tX+10] = (int (*)[tX+10])malloc(sizeof(int[tY+10][tX+10]));
	if (ero == NULL) {perror("eroE\n"); exit(0);}

	int (*risk)[tX+10] = (int (*)[tX+10])malloc(sizeof(int[tY+10][tX+10]));
