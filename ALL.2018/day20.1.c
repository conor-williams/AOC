...
echo $1
sed 's/|)/)/g' $1 | sed 's/^\^//' | sed 's/\$$//' | sed 's/(|/(/g' | sed 's/([NSEW]|/(/g' | sed 's/|[NSEW])/)/g' | sed 's/|)/)/g'  | sed 's/(|/(/g' | sed 's/([NSEW]|/(/g' | sed 's/|[NSEW])/)/g' | sed 's/|)/)/g' | sed 's/(|/(/g' | sed 's/([NSEW]|/(/g' | sed 's/|[NSEW])/)/g' | sed 's/|)/)/g'  | sed 's/(|/(/g' | sed 's/([NSEW]|/(/g' | sed 's/|[NSEW])/)/g' | sed 's/WE//g' | sed 's/EW//g' | sed 's/NS//g' | sed 's/SN//g' | sed 's/WE//g' | sed 's/EW//g' | sed 's/NS//g' | sed 's/SN//g' | sed 's/WE//g' | sed 's/EW//g' | sed 's/NS//g' | sed 's/SN//g' | sed 's/()//g' | sed 's/(\([NSEW][NSEW]*\))/\1/g' |  sed 's/(\([NSEW][NSEW]*\))/\1/g' |  sed 's/(\([NSEW][NSEW]*\))/\1/g' |  sed 's/(\([NSEW][NSEW]*\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g' |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'   |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'   |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'   |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'   |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'   |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'   |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'   |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'   |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'   |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  |  sed 's/(\([NSEW]\+\))/\1/g' | sed 's/(\([NSEW]\+\))/\1/g'  > $1.out
#sed 's/|)/)/g' $1 | sed 's/(|/(/g' | sed 's/([NSEW]|/(/g' | sed 's/|[NSEW])/)/g' | sed 's/|)/)/g'  | sed 's/(|/(/g' | sed 's/([NSEW]|/(/g' | sed 's/|[NSEW])/)/g' | sed 's/|)/)/g' | sed 's/(|/(/g' | sed 's/([NSEW]|/(/g' | sed 's/|[NSEW])/)/g' | sed 's/|)/)/g'  | sed 's/(|/(/g' | sed 's/([NSEW]|/(/g' | sed 's/|[NSEW])/)/g' | sed 's/WE//g' | sed 's/EW//g' | sed 's/NS//g' | sed 's/SN//g' | sed 's/WE//g' | sed 's/EW//g' | sed 's/NS//g' | sed 's/SN//g' | sed 's/WE//g' | sed 's/EW//g' | sed 's/NS//g' | sed 's/SN//g' > $1.out
*/
			...
			if (exp1[q][i] == '|') {
				...
				if (ok == 1) {
					...
					if (tmp1.length() > tmp2.length() ) {
						...
						s2.replace(s2.begin()+Lpos, s2.begin()+Rpos+1, tmp2);
						strcpy(exp1[q], s2.c_str());
						exp1Poses[q] = s2.length();
					} else if (tmp2.length() == tmp2.length()) {
						s1.replace(s1.begin()+Lpos, s1.begin()+Rpos+1, tmp1);
						strcpy(exp1[q], s1.c_str());
						exp1Poses[q] = s1.length();
