...
int main(int argc, char **argv)
{
        ...
        a = fopen(argv[1], "r"); printf("2022 Day 14 part1\n"); fflush(stdout);
...
ag:
	printit3(x, y); justCount(); if (var_count < 800) {} else {getchar();}
	if (x > maxX+3 || x < minX-3) {printf("outx\n");  countit(); x = 500; y = 1; exit(0);}
	if (y < 0 || y > maxY+3) {printf("outy\n"); countit(); x = 500; y = 1; exit(0);}
