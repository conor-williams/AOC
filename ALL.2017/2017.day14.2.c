...
int floodfill(int x, int y, int first) {
	if (grid[y][x] == '1' && grid2[y][x] == 0) {
		grid2[y][x] = floodGroup;
		if (y-1>=0) 			{floodfill(x, y-1, 2);}
		//if (y-1>=0 && x+1<128) 		{floodfill(x+1, y-1, 2);}
		if (x+1<128) 			{floodfill(x+1, y, 2);}
		//if (x+1<128 && y+1<128) 	{floodfill(x+1, y+1, 2);}
		if (y+1<128) 			{floodfill(x, y+1, 2);}
		//if (x-1>=0 && y+1<128) 		{floodfill(x-1, y+1, 2);}
		if (x-1>=0) 			{floodfill(x-1, y, 2);}
		//if (x-1>=0 && y-1>=0) 		{floodfill(x-1, y-1, 2);}
	} else {return 0;}
	if (first == 1) {
		floodGroup++;
	}
